...
function ExperimentDetail() {
  ...
  const upload = async (event: FormEvent<HTMLFormElement>) => { event.preventDefault(); const form = event.currentTarget; try { await api(`/api/experiments/${id}/versions`, { method: "POST", body: new FormData(form) }); form.reset(); await load(); } catch (e) { setError(e); } };
