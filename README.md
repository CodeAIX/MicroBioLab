...
```text
ghcr.io/<owner>/microbio-lab-app:v1.0.1
ghcr.io/<owner>/microbio-lab-builder:v1.0.1
```
...
```bash
docker pull ghcr.io/codeaix/microbio-lab-app:v1.0.1
docker pull ghcr.io/codeaix/microbio-lab-builder:v1.0.1
```
